...
//This uses express and node.js setup to send the correct URL to the getWynncraft function
app.get('/api/wynncraft', async (req, res) => {
    try {
        const { username } = req.query;
        
        //If we are gathering a list of online players (without a username parameter) we default to /player, if a username is searched (a username parameter is passed) we add the username to the url as the API docs specify
